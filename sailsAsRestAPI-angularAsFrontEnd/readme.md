# Sails js and Angular JS into a electron Application

> Sails js as rest API and angular as Front End Application.

Sails JS provide the Res API (Back End App) and Angular JS the user interface (Front End App)
